...
<html lang="en">
  ...
  <div class="container">
  <form method="post" enctype="multipart/form-data" action="save_blog.php">
...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="update_blog.php?id=<?php echo $baris['id'];?>">Edit</a> | <a href="delete_blog.php?id=<?php echo $baris['id'];?>">Hapus</a></td>
    </tr>
    <?php }?>
